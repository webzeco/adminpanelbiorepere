...
const AddStoreScreen = ({ addProduct }) => {
  ...
  const handleParentChange = (e) => {
    ...
    console.log(
      categories.find((cate) => cate.category === e.target.value)
    );
    setChildren(
      categories.find((cate) => cate.category === e.target.value)
        .subCategories
  ...
  return (
    <>
      <div className="container">
        <div className="display-6 px-3 fw-bold mt-3 ">Add Store</div>
